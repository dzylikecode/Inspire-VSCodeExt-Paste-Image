...
function Clipboard() {
  ...
  if (platform == "win32") {
    ...
    powershellWSL = checkPowershellWSL();
...
async function isImageWSL() {
  let powershell = spawn(powershellWSL, [
    "-noprofile",
    "-command",
...
function checkPowershellWSL() {
  let command = "/mnt/c/Windows/System32/WindowsPowerShell/v1.0/powershell.exe";
